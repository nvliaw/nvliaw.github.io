...
//     // Plugin that owns the scene; stores a reference to the Phaser scene
//     this.scene = scene;
//     this.systems = scene.sys;
//
//     if (!scene.sys.settings.isBooted){
//         // Checks if scene is booted, if it hasn't then call boot() method from dialogModalPlugin
//         scene.sys.events.once('boot', this.boot, this);
//     }
// };
//
// // Register plugin with Phaser's PluginManager
// dialogModalPlugin.register = function(PluginManager){
//     // called by Phaser's PluginFile Loader (from PluginManager)
//     // the register() from the PluginManager takes three parameters:
//     // name of plugin, reference to plugin object, local mapping of where plugin will be available
//     PluginManager.register('dialogModalPlugin', dialogModalPlugin, 'dialogModal');
// };
//
// dialogModalPlugin.prototype = {
//     // Call whenever this plugin is called by the PluginManager
//     boot: function () {
//         // created a eventEmitter variable to listen to different scene events (start, update, pause, destroy, ...)
//         let eventEmitter = this.systems.events;
//         // Listen espeically for the 'shutdown' and 'destroy' events which calls shutdown() and destroy() respectively
//         eventEmitter.on('shutdown', this.shutdown, this);
//         eventEmitter.on('destroy', this.destroy, this);
//     },
//     // Call when a scene shuts down so we can do any 'clean up'
//     shutdown: function(){
//
//     },
//     // Call when a scene is destroyed by the SceneManager
//     destroy: function(){
//         // Ensures any scene that is destroyed goes through proper 'clean up'
//         this.shutdown();
