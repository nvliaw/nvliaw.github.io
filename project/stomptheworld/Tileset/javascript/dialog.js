...
var content = "Did you ever hear the tragedy of Darth Thompson the Fierce?\n" +
    "I thought not. It's not a program the instructors would code for you. It's a CST legend. Darth Thompson was a Dark Lord of Python, so powerful and so wise he could use the Code to influence the grade book to create A's... He had such a knowledge of the programming that he could even keep the ones he cared about from failing. The programming of the Code is a pathway to many abilities some consider to be unnatural. He became so powerful... the only thing he was afraid of was losing his files, which eventually, of course, he did. Unfortunately, he taught his students to commit to GitHub, then his students deleted 'master' in his sleep. It's ironic he could save others from failing, but not himself.";
