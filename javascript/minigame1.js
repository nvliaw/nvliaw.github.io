...
export default class MiniGame1 extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.audioSprite('sfx', 'audio/minigame.json', ['audio/minigame.mp3', 'audio/minigame.ogg', 'audio/minigame.m4a', 'audio/minigame.ac3'])
    }
    ...
    create() {
        ...
        this.meat = this.physics.add.sprite(Phaser.Math.Between(screenwidth * 0.10, screenwidth * 0.85), Phaser.Math.Between(screenheight * 0.10, screenheight * 0.85), this.object + 'set', 0);
        this.rice = this.physics.add.sprite(Phaser.Math.Between(screenwidth * 0.10, screenwidth * 0.85), Phaser.Math.Between(screenheight * 0.10, screenheight * 0.85), this.object + 'set', 1);
        this.cheese = this.physics.add.sprite(Phaser.Math.Between(screenwidth * 0.10, screenwidth * 0.85), Phaser.Math.Between(screenheight * 0.10, screenheight * 0.85), this.object + 'set', 2);
        this.fish = this.physics.add.sprite(Phaser.Math.Between(screenwidth * 0.10, screenwidth * 0.85), Phaser.Math.Between(screenheight * 0.10, screenheight * 0.85), this.object + 'set', 3);

        // Three broccoli to make it more challenging
        this.broccoli_1 = this.physics.add.sprite(Phaser.Math.Between(screenwidth * 0.10, screenwidth * 0.85), Phaser.Math.Between(screenheight * 0.10, screenheight * 0.85), this.object + 'set', 4);
        this.broccoli_2 = this.physics.add.sprite(Phaser.Math.Between(screenwidth * 0.10, screenwidth * 0.85), Phaser.Math.Between(screenheight * 0.10, screenheight * 0.85), this.object + 'set', 4);
        this.broccoli_3 = this.physics.add.sprite(Phaser.Math.Between(screenwidth * 0.10, screenwidth * 0.85), Phaser.Math.Between(screenheight * 0.10, screenheight * 0.85), this.object + 'set', 4);

        this.cameras.main.setBackgroundColor('#3498db');

        // Scale all sprites
        this.player.setScale(2, 2);
        this.cheese.setScale(2, 2);
        this.meat.setScale(2, 2);
        this.broccoli_1.setScale(2, 2);
        this.broccoli_2.setScale(2, 2);
        this.broccoli_3.setScale(2, 2);
        this.fish.setScale(2, 2);
        this.rice.setScale(2, 2);
        ...
        let audiomap = this.cache.json.get('sfx').spritemap;

        this.sound.playAudioSprite('sfx', 'bubblebobble');
    ...
    hit_meat() {
        ...
        this.sound.playAudioSprite('sfx', 'sfx_coin_double1');
    }

    hit_rice() {
        //Play tween animation
        this.playtween(this.rice, +3);
        ...
        this.sound.playAudioSprite('sfx', 'sfx_sounds_damage1');
    }

    hit_cheese() {
        //Play tween animation
        this.playtween(this.cheese, +1);
        // Change the position of the cheese randomly
